...
How many cycles at 500bp per read and (let's assume) 384 reads per run would it take to sequence the human genome at 3 billion bases one time?
...
[Almost...](https://www.bgi.com/us/human-whole-genome-sequencing-from-600/)

Based on DNA Nanoball Sequencing:

```{R, echo=F}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/a/a9/BGI_DNA_nanoball_tube_to_array_2.png")
```
...
<div align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/0bqIBtMS3xw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
[BGI is getting sued by Illumina for patent infringement](https://www.genomeweb.com/sequencing/illumina-wins-uk-patent-infringement-suit-against-bgi-affiliates)
...
Research one sequencing technology and contribute to the shared class file.
